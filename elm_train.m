...
if isLoad==1
    train_data=GTSRBDataRead('E:\Ñ¸À×ÏÂÔØ\GTSRB_DATASET\GTSRB_Final_Training_HOG\GTSRB\Final_Training\HOG\HOG_01');
    save('train_data2.mat','train_data');
else
    tmpTraindata=load('train_data2.mat');
    train_data=tmpTraindata.train_data;
end

T=train_data(:,1)';  %class Id
P=train_data(:,2:size(train_data,2))';  %HOG feature
